...
function showAdminItems()
{
 //var foodItems  =  [
   //      { id: 1, name: 'Sandwich', price: 99, active: 'Yes', dateOfLaunch: '2017-03-25', category: 'Main Course', freeDelivery: 'Yes' },
    ...
    //getting food items object arrOfFoodItem say from localstorage
    var foodItems = JSON.parse(localStorage.getItem("arrOfFoodItems"));
    localStorage.setItem("arrOfFoodItems",JSON.stringify(foodItems));

    //table div 
    var tableBody = document.getElementById("admin-table");

    //Traversing through arrOfFoodItemsay to display food items
...
function editItems()
{
    ...
    // debugger;
    const foodItems = JSON.parse(localStorage.getItem("arrOfFoodItems"));
    // debugger;
